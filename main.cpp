...
void emptyTest(void) {
	printf("\n\n******* Starting General Test #2 *******\n");
	char dictionary[] = "";
	char article[] = "this are all words that should work";
	spellCheck(article, dictionary);
	printf("****DONE****\n");
}
...
void superPuctiationTest(void) {
	printf("\n\n******* Starting General Test #2 *******\n");
	char dictionary[] = "hellow\nworld\n";
	char article []= "hello world,hellow,hellow,cat,not,yes'kool;pop";
	spellCheck(article, dictionary);
	printf("****DONE****\n");
}
...
void spaceTest(void) {
	printf("\n\n******* Starting General Test #2 *******\n");
	char dictionary[] = "alpha\n";
	char article[] = "   alpha  betha   alpha   betha";
	spellCheck(article, dictionary);
	printf("****DONE****\n");
}
